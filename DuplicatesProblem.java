...
public class DuplicatesProblem
{
   public static void main(String[] args)
   {
      ...
      LinkedList llist = new LinkedList();
         ...
         llist.head.next.next.next = new ListNode(12);
         llist.head.next.next.next.next = new ListNode(12);
      System.out.println("input: " + llist);
      deleteDuplicates(llist);
      System.out.println("output: " + llist);
      llist = new LinkedList();
         llist.head = new ListNode(4);
         llist.head.next = new ListNode(4);
         llist.head.next.next = new ListNode(6);
         llist.head.next.next.next = new ListNode(6);
         llist.head.next.next.next.next = new ListNode(7);
      System.out.println("\ninput: " + llist);
      deleteDuplicates(llist);
      System.out.println("output: " + llist);
